# Phase 11H — Preview Modes + Live/Draft Compare

## Objective

Close the two functional review gaps found by the Phase 11 final audit without redesigning the Publish UX or changing database behavior.
