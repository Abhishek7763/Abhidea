-- ABHIDEA Phase 10C follow-up: harden the already-merged Create Draft RPC.
-- Forward-only CREATE OR REPLACE migration; the original Phase 10C migration remains immutable.
